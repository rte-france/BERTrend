...
class ArticleScoringAPIConfig(BaseSettings):
    host: str
    port: int
    number_workers: int


def get_config() -> ArticleScoringAPIConfig:
    """
    ...
    """
    config_file = os.environ.get("ARTICLE_SCORING_API_CONFIG_FILE", None)
    if config_file is None:
        config_file = DEFAULT_CONFIG_FILE
    with open(config_file, "rb") as f:
        return ArticleScoringAPIConfig(**tomllib.load(f))
