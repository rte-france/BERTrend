...
@patch("bertrend.bertrend_apps.data_provider.google_news_provider.decode_google_news_url")
...
def test_google_get_articles(mock_process, google_provider):
    google_provider.gn.search = MagicMock(return_value={"entries": [{"title": "Entry 1"}]})
