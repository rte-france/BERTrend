...
from bertrend.bertrend_apps.prospective_demo import NOISE, STRONG_SIGNALS, WEAK_SIGNALS
from bertrend.bertrend_apps.prospective_demo.i18n import translate
from bertrend.bertrend_apps.prospective_demo.models_info import get_models_info
